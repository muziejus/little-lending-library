    // static_js_start
      ...
      var davidAdnopoz = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/4"><h3>David Adnopoz</h3></a><p>58 Dean St #12 Soho<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(davidAdnopoz);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="davidAdnopoz.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="davidAdnopoz.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([51.5147368, -0.1345577], {
            color: davidAdnopozColor
          }).bindPopup('<a href="/people/4"><h3>David Adnopoz</h3></a><p>142 Wardour St Soho<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(davidAdnopoz);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="davidAdnopoz.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="davidAdnopoz.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var peterArmstrong = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/11"><h3>Peter Armstrong</h3></a><p>16 W Mall<br />Bristol, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(peterArmstrong);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="peterArmstrong.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="peterArmstrong.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([51.4578856, -2.6142163], {
            color: peterArmstrongColor
          }).bindPopup('<a href="/people/11"><h3>Peter Armstrong</h3></a><p>1 Richmond Park Rd<br />Bristol, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(peterArmstrong);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="peterArmstrong.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="peterArmstrong.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var lewisWarsh = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/16"><h3>Lewis Warsh</h3></a><p>Zanbock’s Cottage<br />Bustins Island, ME<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(lewisWarsh);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="lewisWarsh.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="lewisWarsh.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([42.3705191, -71.1027358], {
            color: lewisWarshColor
          }).bindPopup('<a href="/people/16"><h3>Lewis Warsh</h3></a><p>65 Inman St<br />Cambridge, MA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(lewisWarsh);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="lewisWarsh.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="lewisWarsh.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.729047, -73.98809], {
            color: lewisWarshColor
          }).bindPopup('<a href="/people/16"><h3>Lewis Warsh</h3></a><p>33 St Marks Pl #7<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(lewisWarsh);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="lewisWarsh.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="lewisWarsh.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.7711382, -122.4528967], {
            color: lewisWarshColor
          }).bindPopup('<a href="/people/16"><h3>Lewis Warsh</h3></a><p>2031B Oak St<br />San Francisco, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(lewisWarsh);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="lewisWarsh.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="lewisWarsh.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.731867, -73.983213], {
            color: lewisWarshColor
          }).bindPopup('<a href="/people/16"><h3>Lewis Warsh</h3></a><p>PO Box 257 Peter Stuyvesant Station<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(lewisWarsh);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="lewisWarsh.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="lewisWarsh.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var bruceAndrews = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/22"><h3>Bruce Andrews</h3></a><p>15 Trowbridge St #3<br />Cambridge, MA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(bruceAndrews);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="bruceAndrews.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="bruceAndrews.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([38.9102409, -77.0557333], {
            color: bruceAndrewsColor
          }).bindPopup('<a href="/people/22"><h3>Bruce Andrews</h3></a><p>2700 Q St NW<br />Washington, DC<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(bruceAndrews);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="bruceAndrews.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="bruceAndrews.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var peterDavidson = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/26"><h3>Peter Davidson</h3></a><p>8 Arlington St<br />Boston, MA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(peterDavidson);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="peterDavidson.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="peterDavidson.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var larryBensky = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/27"><h3>Larry Bensky</h3></a><p>54 Vicksburg St<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(larryBensky);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="larryBensky.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="larryBensky.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([48.8900374, 2.3487076], {
            color: larryBenskyColor
          }).bindPopup('<a href="/people/27"><h3>Larry Bensky</h3></a><p>9 Rue Simart<br />Paris, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(larryBensky);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="larryBensky.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="larryBensky.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([48.8718194, 2.2986843], {
            color: larryBenskyColor
          }).bindPopup('<a href="/people/27"><h3>Larry Bensky</h3></a><p>16 Rue Vernet<br />Paris, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(larryBensky);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="larryBensky.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="larryBensky.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([51.5126198, -0.1743199], {
            color: larryBenskyColor
          }).bindPopup('<a href="/people/27"><h3>Larry Bensky</h3></a><p>8 Sussex Mews W<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(larryBensky);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="larryBensky.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="larryBensky.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([48.8538133, 2.336289], {
            color: larryBenskyColor
          }).bindPopup('<a href="/people/27"><h3>Larry Bensky</h3></a><p>765 Place du Palais Bourbon<br />Paris, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(larryBensky);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="larryBensky.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="larryBensky.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([39.367146, 26.1751462], {
            color: larryBenskyColor
          }).bindPopup('<a href="/people/27"><h3>Larry Bensky</h3></a><p><br />Molyvos Lesvos (Mytilini), <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(larryBensky);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="larryBensky.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="larryBensky.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.736857, -74.002332], {
            color: larryBenskyColor
          }).bindPopup('<a href="/people/27"><h3>Larry Bensky</h3></a><p>20 Bank St<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(larryBensky);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="larryBensky.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="larryBensky.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.7339395, -73.9987797], {
            color: larryBenskyColor
          }).bindPopup('<a href="/people/27"><h3>Larry Bensky</h3></a><p>64 W 9th St<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(larryBensky);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="larryBensky.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="larryBensky.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.7999688, -122.4052921], {
            color: larryBenskyColor
          }).bindPopup('<a href="/people/27"><h3>Larry Bensky</h3></a><p>373 Green St<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(larryBensky);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="larryBensky.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="larryBensky.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.742142, -122.429817], {
            color: larryBenskyColor
          }).bindPopup('<a href="/people/27"><h3>Larry Bensky</h3></a><p>446 30th St<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(larryBensky);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="larryBensky.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="larryBensky.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.765211, -122.432861], {
            color: larryBenskyColor
          }).bindPopup('<a href="/people/27"><h3>Larry Bensky</h3></a><p>251 Noe St<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(larryBensky);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="larryBensky.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="larryBensky.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var jackBoyce = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/38"><h3>Jack Boyce</h3></a><p>PO Box 185<br />Bodega Bay, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(jackBoyce);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="jackBoyce.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="jackBoyce.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.9093702, -122.6863733], {
            color: jackBoyceColor
          }).bindPopup('<a href="/people/38"><h3>Jack Boyce</h3></a><p>PO Box 48<br />Bolinas, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(jackBoyce);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="jackBoyce.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="jackBoyce.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.787811, -122.430486], {
            color: jackBoyceColor
          }).bindPopup('<a href="/people/38"><h3>Jack Boyce</h3></a><p>1907 Buchanan St<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(jackBoyce);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="jackBoyce.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="jackBoyce.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var josephBottone = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/39"><h3>Joseph Bottone</h3></a><p>200 N Jefferson St<br />Eugene, OR<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(josephBottone);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="josephBottone.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="josephBottone.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.766471, -122.432503], {
            color: josephBottoneColor
          }).bindPopup('<a href="/people/39"><h3>Joseph Bottone</h3></a><p>69 Henry St<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(josephBottone);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="josephBottone.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="josephBottone.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var robertBly = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/43"><h3>Robert Bly</h3></a><p>Odin House<br />Madison, MN<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(robertBly);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="robertBly.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="robertBly.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([48.8561669, 2.3327628], {
            color: robertBlyColor
          }).bindPopup('<a href="/people/43"><h3>Robert Bly</h3></a><p>50 Rue Jacob<br />Paris, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(robertBly);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="robertBly.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="robertBly.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([51.9524997, 0.3457911], {
            color: robertBlyColor
          }).bindPopup('<a href="/people/43"><h3>Robert Bly</h3></a><p>21 Mill End<br />Thaxted, Dunmow, Essex, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(robertBly);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="robertBly.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="robertBly.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var drNealBlumenfeld = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/45"><h3>Dr. Neal Blumenfeld</h3></a><p>2380 Ellsworth St<br />Berkeley, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(drNealBlumenfeld);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="drNealBlumenfeld.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="drNealBlumenfeld.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var williamBurroughs = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/56"><h3>William Burroughs</h3></a><p>Rushmore Hotel, 11 Trebovir Rd<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(williamBurroughs);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="williamBurroughs.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="williamBurroughs.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var jamesBrodey = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/58"><h3>James Brodey</h3></a><p>2308 W 4th St<br />Los Angeles, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(jamesBrodey);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="jamesBrodey.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="jamesBrodey.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.7290188, -73.9807509], {
            color: jamesBrodeyColor
          }).bindPopup('<a href="/people/58"><h3>James Brodey</h3></a><p>507 E 12th St<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(jamesBrodey);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="jamesBrodey.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="jamesBrodey.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.7613232, -122.4505437], {
            color: jamesBrodeyColor
          }).bindPopup('<a href="/people/58"><h3>James Brodey</h3></a><p>1507 Shrader St<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(jamesBrodey);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="jamesBrodey.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="jamesBrodey.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([34.0619824, -118.2504169], {
            color: jamesBrodeyColor
          }).bindPopup('<a href="/people/58"><h3>James Brodey</h3></a><p>1010 W Temple St<br />Los Angeles, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(jamesBrodey);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="jamesBrodey.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="jamesBrodey.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.725475, -73.99259], {
            color: jamesBrodeyColor
          }).bindPopup('<a href="/people/58"><h3>James Brodey</h3></a><p>3 Bleecker St<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(jamesBrodey);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="jamesBrodey.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="jamesBrodey.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var drJosephBerke = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/60"><h3>Dr. Joseph Berke</h3></a><p>4 St Georges Terrace<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(drJosephBerke);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="drJosephBerke.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="drJosephBerke.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([51.5177712, -0.1478526], {
            color: drJosephBerkeColor
          }).bindPopup('<a href="/people/60"><h3>Dr. Joseph Berke</h3></a><p>37 Queen Anne St Marylebone<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(drJosephBerke);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="drJosephBerke.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="drJosephBerke.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var sarahBurgess = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/62"><h3>Sarah Burgess</h3></a><p>30 Ifield Rd Kensington<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(sarahBurgess);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="sarahBurgess.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="sarahBurgess.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var steveBrooks = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/76"><h3>Steve Brooks</h3></a><p>35 Campus Circle<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(steveBrooks);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="steveBrooks.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="steveBrooks.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.7635968, -122.4630396], {
            color: steveBrooksColor
          }).bindPopup('<a href="/people/76"><h3>Steve Brooks</h3></a><p>1328 6th Ave<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(steveBrooks);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="steveBrooks.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="steveBrooks.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var robertCreeley = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/80"><h3>Robert Creeley</h3></a><p>9596 Knoll Rd<br />Eden, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(robertCreeley);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="robertCreeley.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="robertCreeley.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([42.6417617, -70.6717116], {
            color: robertCreeleyColor
          }).bindPopup('<a href="/people/80"><h3>Robert Creeley</h3></a><p>Riverdale Station<br />Gloucester, MA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(robertCreeley);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="robertCreeley.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="robertCreeley.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.9093702, -122.6863733], {
            color: robertCreeleyColor
          }).bindPopup('<a href="/people/80"><h3>Robert Creeley</h3></a><p>PO Box 334<br />Bolinas, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(robertCreeley);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="robertCreeley.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="robertCreeley.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([35.3069845, -106.4247468], {
            color: robertCreeleyColor
          }).bindPopup('<a href="/people/80"><h3>Robert Creeley</h3></a><p><br />Placitas, NM<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(robertCreeley);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="robertCreeley.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="robertCreeley.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([42.944704, -78.842978], {
            color: robertCreeleyColor
          }).bindPopup('<a href="/people/80"><h3>Robert Creeley</h3></a><p>256 Woodbridge Ave<br />Buffalo, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(robertCreeley);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="robertCreeley.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="robertCreeley.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var victorColeman = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/82"><h3>Victor Coleman</h3></a><p>109 Cowan Ave<br />Toronto, ON<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(victorColeman);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="victorColeman.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="victorColeman.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([43.6605241, -79.4671305], {
            color: victorColemanColor
          }).bindPopup('<a href="/people/82"><h3>Victor Coleman</h3></a><p>257 Humberside<br />Toronto, ON<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(victorColeman);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="victorColeman.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="victorColeman.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var joeCeravolo = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/91"><h3>Joe Ceravolo</h3></a><p>276 Clifton Ave<br />Newark, NJ<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(joeCeravolo);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="joeCeravolo.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="joeCeravolo.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.7947035, -74.1925678], {
            color: joeCeravoloColor
          }).bindPopup('<a href="/people/91"><h3>Joe Ceravolo</h3></a><p>65 Spruce St<br />Bloomfield, NJ<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(joeCeravolo);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="joeCeravolo.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="joeCeravolo.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var clarkCoolidge = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/96"><h3>Clark Coolidge</h3></a><p>PO Box 224<br />New Lebanon, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(clarkCoolidge);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="clarkCoolidge.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="clarkCoolidge.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([41.840397, -71.397653], {
            color: clarkCoolidgeColor
          }).bindPopup('<a href="/people/96"><h3>Clark Coolidge</h3></a><p>272 Morris Ave<br />Providence, RI<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(clarkCoolidge);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="clarkCoolidge.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="clarkCoolidge.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.7870153, -73.9755443], {
            color: clarkCoolidgeColor
          }).bindPopup('<a href="/people/96"><h3>Clark Coolidge</h3></a><p>W 85th St<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(clarkCoolidge);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="clarkCoolidge.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="clarkCoolidge.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([41.837171, -71.3999879], {
            color: clarkCoolidgeColor
          }).bindPopup('<a href="/people/96"><h3>Clark Coolidge</h3></a><p>48 Brenton Ave<br />Providence, RI<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(clarkCoolidge);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="clarkCoolidge.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="clarkCoolidge.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([42.3620461, -71.104207], {
            color: clarkCoolidgeColor
          }).bindPopup('<a href="/people/96"><h3>Clark Coolidge</h3></a><p>21 Watson St<br />Cambridge, MA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(clarkCoolidge);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="clarkCoolidge.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="clarkCoolidge.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.7990751, -122.4046482], {
            color: clarkCoolidgeColor
          }).bindPopup('<a href="/people/96"><h3>Clark Coolidge</h3></a><p>454 Vallejo St<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(clarkCoolidge);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="clarkCoolidge.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="clarkCoolidge.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([41.8410129, -71.397374], {
            color: clarkCoolidgeColor
          }).bindPopup('<a href="/people/96"><h3>Clark Coolidge</h3></a><p>292 Morris Ave<br />Providence, RI<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(clarkCoolidge);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="clarkCoolidge.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="clarkCoolidge.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var davidCoates = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/99"><h3>David Coates</h3></a><p>The Cottage, George Street Mews<br />Oxford, Oxfordshire, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(davidCoates);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="davidCoates.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="davidCoates.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var didiCrane = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/102"><h3>Didi Crane</h3></a><p>2563 Clay St #4<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(didiCrane);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="didiCrane.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="didiCrane.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var steveCarey = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/107"><h3>Steve Carey</h3></a><p>2941 Pine St<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(steveCarey);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="steveCarey.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="steveCarey.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([34.0542985, -118.2823206], {
            color: steveCareyColor
          }).bindPopup('<a href="/people/107"><h3>Steve Carey</h3></a><p>919 S Park View St<br />Los Angeles, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(steveCarey);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="steveCarey.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="steveCarey.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.8590937, -122.4852507], {
            color: steveCareyColor
          }).bindPopup('<a href="/people/107"><h3>Steve Carey</h3></a><p>PO Box 563<br />Sausalito, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(steveCarey);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="steveCarey.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="steveCarey.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.766823, -122.447543], {
            color: steveCareyColor
          }).bindPopup('<a href="/people/107"><h3>Steve Carey</h3></a><p>273 Frederick St<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(steveCarey);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="steveCarey.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="steveCarey.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.7670344, -122.4530622], {
            color: steveCareyColor
          }).bindPopup('<a href="/people/107"><h3>Steve Carey</h3></a><p>822 Stanyan St<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(steveCarey);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="steveCarey.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="steveCarey.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var nilNil = L.featureGroup([
          L.circleMarker([40.9179505, -74.139444], {
            color: nilNilColor
          }).bindPopup('<a href="/people/124"><h3>Nil Nil</h3></a><p>139 Derrom Ave<br />, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(nilNil);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="nilNil.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="nilNil.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.856018, -122.265311], {
            color: nilNilColor
          }).bindPopup('<a href="/people/124"><h3>Nil Nil</h3></a><p>2927 Lorina St<br />Berkeley, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(nilNil);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="nilNil.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="nilNil.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.862245, -122.254595], {
            color: nilNilColor
          }).bindPopup('<a href="/people/124"><h3>Nil Nil</h3></a><p>2633 Benvenue<br />Berkeley, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(nilNil);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="nilNil.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="nilNil.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.9093702, -122.6863733], {
            color: nilNilColor
          }).bindPopup('<a href="/people/124"><h3>Nil Nil</h3></a><p>PO Box 188<br />Bolinas, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(nilNil);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="nilNil.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="nilNil.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.733803, -74.0023857], {
            color: nilNilColor
          }).bindPopup('<a href="/people/124"><h3>Nil Nil</h3></a><p>Lion’s Head, 59 Christopher St<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(nilNil);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="nilNil.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="nilNil.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.7325, -73.998692], {
            color: nilNilColor
          }).bindPopup('<a href="/people/124"><h3>Nil Nil</h3></a><p>Hotel Earle, 103 Waverly Place<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(nilNil);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="nilNil.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="nilNil.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.9093702, -122.6863733], {
            color: nilNilColor
          }).bindPopup('<a href="/people/124"><h3>Nil Nil</h3></a><p><br />Bolinas, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(nilNil);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="nilNil.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="nilNil.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var edwardDorn = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/132"><h3>Edward Dorn</h3></a><p>911 W Diversey Pkwy<br />Chicago, IL<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(edwardDorn);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="edwardDorn.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="edwardDorn.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.7868237, -122.4369219], {
            color: edwardDornColor
          }).bindPopup('<a href="/people/132"><h3>Edward Dorn</h3></a><p>1811 Pierce St #3<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(edwardDorn);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="edwardDorn.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="edwardDorn.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.755102, -122.4731063], {
            color: edwardDornColor
          }).bindPopup('<a href="/people/132"><h3>Edward Dorn</h3></a><p>885 Noriega St<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(edwardDorn);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="edwardDorn.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="edwardDorn.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([41.156836, -81.35023], {
            color: edwardDornColor
          }).bindPopup('<a href="/people/132"><h3>Edward Dorn</h3></a><p>521 Crain Ave<br />Kent, OH<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(edwardDorn);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="edwardDorn.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="edwardDorn.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([51.8734875, 0.7122493], {
            color: edwardDornColor
          }).bindPopup('<a href="/people/132"><h3>Edward Dorn</h3></a><p>“Linden” Colchester Rd<br />Colchester, Essex, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(edwardDorn);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="edwardDorn.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="edwardDorn.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([51.885149, 0.8825745], {
            color: edwardDornColor
          }).bindPopup('<a href="/people/132"><h3>Edward Dorn</h3></a><p>6 Victoria Rd<br />Colchester, Essex, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(edwardDorn);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="edwardDorn.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="edwardDorn.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([42.8688818, -112.441835], {
            color: edwardDornColor
          }).bindPopup('<a href="/people/132"><h3>Edward Dorn</h3></a><p>843 E Clark St<br />Pocatello, ID, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(edwardDorn);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="edwardDorn.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="edwardDorn.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([51.8904347, 0.8646388], {
            color: edwardDornColor
          }).bindPopup('<a href="/people/132"><h3>Edward Dorn</h3></a><p>187 Lexden Rd<br />Colchester, Essex, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(edwardDorn);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="edwardDorn.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="edwardDorn.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([42.7962906, -70.9775075], {
            color: edwardDornColor
          }).bindPopup('<a href="/people/132"><h3>Edward Dorn</h3></a><p>Stewart St<br />West Newbury, MA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(edwardDorn);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="edwardDorn.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="edwardDorn.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var richardDuerden = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/138"><h3>Richard Duerden</h3></a><p>1506 Masonic Ave<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(richardDuerden);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="richardDuerden.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="richardDuerden.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.762649, -122.449931], {
            color: richardDuerdenColor
          }).bindPopup('<a href="/people/138"><h3>Richard Duerden</h3></a><p>130 Rivoli St<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(richardDuerden);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="richardDuerden.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="richardDuerden.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var jimDine = L.featureGroup([
          L.circleMarker([51.4945339, -0.1500912], {
            color: jimDineColor
          }).bindPopup('<a href="/people/157"><h3>Jim Dine</h3></a><p>60 Chester Square Belgravia<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(jimDine);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="jimDine.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="jimDine.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([51.4860068, -0.1705867], {
            color: jimDineColor
          }).bindPopup('<a href="/people/157"><h3>Jim Dine</h3></a><p>13 Glebe Pl Chelsea<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(jimDine);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="jimDine.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="jimDine.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([42.975268, -72.5217237], {
            color: jimDineColor
          }).bindPopup('<a href="/people/157"><h3>Jim Dine</h3></a><p>RFD 3<br />Putney, VT<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(jimDine);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="jimDine.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="jimDine.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var ianHamiltonFinlay = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/173"><h3>Ian Hamilton Finlay</h3></a><p>Gledfield Farmhouse<br />Ardgay Ross-Shire, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(ianHamiltonFinlay);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="ianHamiltonFinlay.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="ianHamiltonFinlay.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([55.9590414, -3.2018073], {
            color: ianHamiltonFinlayColor
          }).bindPopup('<a href="/people/173"><h3>Ian Hamilton Finlay</h3></a><p>24 Fettes Row<br />Edinburgh, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(ianHamiltonFinlay);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="ianHamiltonFinlay.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="ianHamiltonFinlay.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var maxFinstein = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/174"><h3>Max Finstein</h3></a><p>1711 Buchanan St Japan Center<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(maxFinstein);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="maxFinstein.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="maxFinstein.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([35.5830906, -105.7700174], {
            color: maxFinsteinColor
          }).bindPopup('<a href="/people/174"><h3>Max Finstein</h3></a><p><br />Glorieta, NM<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(maxFinstein);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="maxFinstein.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="maxFinstein.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.7716569, -122.4414472], {
            color: maxFinsteinColor
          }).bindPopup('<a href="/people/174"><h3>Max Finstein</h3></a><p>1274A Page St<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(maxFinstein);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="maxFinstein.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="maxFinstein.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.771104, -122.451067], {
            color: maxFinsteinColor
          }).bindPopup('<a href="/people/174"><h3>Max Finstein</h3></a><p>1921 Oak St<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(maxFinstein);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="maxFinstein.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="maxFinstein.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var elaineFeinstein = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/175"><h3>Elaine Feinstein</h3></a><p>13th Close Babraham<br />Cambridge, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(elaineFeinstein);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="elaineFeinstein.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="elaineFeinstein.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([52.1872479, 0.173645], {
            color: elaineFeinsteinColor
          }).bindPopup('<a href="/people/175"><h3>Elaine Feinstein</h3></a><p>47 High St<br />Cambridge, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(elaineFeinstein);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="elaineFeinstein.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="elaineFeinstein.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var harryFainlight = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/179"><h3>Harry Fainlight</h3></a><p>24 Arundel Gardens<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(harryFainlight);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="harryFainlight.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="harryFainlight.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([51.5428041, -0.1130989], {
            color: harryFainlightColor
          }).bindPopup('<a href="/people/179"><h3>Harry Fainlight</h3></a><p>1 Belitha Villas<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(harryFainlight);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="harryFainlight.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="harryFainlight.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var ruthFainlight = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/186"><h3>Ruth Fainlight</h3></a><p>97 Larkhall Rise<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(ruthFainlight);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="ruthFainlight.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="ruthFainlight.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var allenGinsberg = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/197"><h3>Allen Ginsberg</h3></a><p>408 E 10th St #4C<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(allenGinsberg);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="allenGinsberg.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="allenGinsberg.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.7226831, -73.9793719], {
            color: allenGinsbergColor
          }).bindPopup('<a href="/people/197"><h3>Allen Ginsberg</h3></a><p>704 E 5th St<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(allenGinsberg);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="allenGinsberg.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="allenGinsberg.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.7088575, -97.4281484], {
            color: allenGinsbergColor
          }).bindPopup('<a href="/people/197"><h3>Allen Ginsberg</h3></a><p>1060 N Northwest Pkwy<br />Wichita, KS<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(allenGinsberg);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="allenGinsberg.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="allenGinsberg.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([42.7956294, -74.7532018], {
            color: allenGinsbergColor
          }).bindPopup('<a href="/people/197"><h3>Allen Ginsberg</h3></a><p>East Hill Farm, RD2<br />Cherry Valley, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(allenGinsberg);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="allenGinsberg.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="allenGinsberg.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.731867, -73.983213], {
            color: allenGinsbergColor
          }).bindPopup('<a href="/people/197"><h3>Allen Ginsberg</h3></a><p>PO Box 582 Peter Stuyvesant Station<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(allenGinsberg);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="allenGinsberg.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="allenGinsberg.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.732888, -73.99731], {
            color: allenGinsbergColor
          }).bindPopup('<a href="/people/197"><h3>Allen Ginsberg</h3></a><p>17 W 8th St<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(allenGinsberg);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="allenGinsberg.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="allenGinsberg.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.797601, -122.406579], {
            color: allenGinsbergColor
          }).bindPopup('<a href="/people/197"><h3>Allen Ginsberg</h3></a><p>261 Columbus Ave<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(allenGinsberg);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="allenGinsberg.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="allenGinsberg.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var gerryGilbert = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/200"><h3>Gerry Gilbert</h3></a><p>664 W 11th Ave<br />Vancouver, BC<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(gerryGilbert);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="gerryGilbert.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="gerryGilbert.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([51.491461, -0.1600362], {
            color: gerryGilbertColor
          }).bindPopup('<a href="/people/200"><h3>Gerry Gilbert</h3></a><p>16 King’s Rd Fulham<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(gerryGilbert);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="gerryGilbert.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="gerryGilbert.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var harryMathews = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/211"><h3>Harry Mathews</h3></a><p>35 Rue de Varenne<br />Paris, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(harryMathews);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="harryMathews.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="harryMathews.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var donaldHall = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/233"><h3>Donald Hall</h3></a><p>1915 S University Ave<br />Ann Arbor, MI<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(donaldHall);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="donaldHall.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="donaldHall.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([42.277106, -83.72579], {
            color: donaldHallColor
          }).bindPopup('<a href="/people/233"><h3>Donald Hall</h3></a><p>12 Geddes Heights Dr<br />Ann Arbor, MI<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(donaldHall);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="donaldHall.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="donaldHall.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([42.275379, -83.726837], {
            color: donaldHallColor
          }).bindPopup('<a href="/people/233"><h3>Donald Hall</h3></a><p>1715 S University Ave<br />Ann Arbor, MI<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(donaldHall);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="donaldHall.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="donaldHall.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([42.2767064, -83.7450407], {
            color: donaldHallColor
          }).bindPopup('<a href="/people/233"><h3>Donald Hall</h3></a><p>433 Hamilton Pl #3<br />Ann Arbor, MI<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(donaldHall);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="donaldHall.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="donaldHall.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var dRHazelton = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/235"><h3>D.R. Hazelton</h3></a><p>1636 Martin Luther King Jr Way<br />Berkeley, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(dRHazelton);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="dRHazelton.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="dRHazelton.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.870889, -122.291659], {
            color: dRHazeltonColor
          }).bindPopup('<a href="/people/235"><h3>D.R. Hazelton</h3></a><p>1125 Hearst Ave<br />Berkeley, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(dRHazelton);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="dRHazelton.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="dRHazelton.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var phyllisMasekHarris = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/237"><h3>Phyllis Masek Harris</h3></a><p>281 Salem St<br />Wakefield, MA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(phyllisMasekHarris);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="phyllisMasekHarris.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="phyllisMasekHarris.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var kateHeliczer = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/241"><h3>Kate Heliczer</h3></a><p>Hereford Buildings #23, Old Church St Chelsea<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(kateHeliczer);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="kateHeliczer.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="kateHeliczer.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var johnHaines = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/242"><h3>John Haines</h3></a><p>Mile 68, Richardson Highway<br />Fairbanks, AK<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(johnHaines);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="johnHaines.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="johnHaines.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var leeHarwood = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/244"><h3>Lee Harwood</h3></a><p>37 Wellclose Square<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(leeHarwood);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="leeHarwood.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="leeHarwood.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.8222499, -74.161454], {
            color: leeHarwoodColor
          }).bindPopup('<a href="/people/244"><h3>Lee Harwood</h3></a><p>435 Prospect St<br />Nutley, NJ<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(leeHarwood);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="leeHarwood.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="leeHarwood.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([51.510176, -0.0612615], {
            color: leeHarwoodColor
          }).bindPopup('<a href="/people/244"><h3>Lee Harwood</h3></a><p>Brockmer House 69, Crowder St<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(leeHarwood);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="leeHarwood.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="leeHarwood.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var michaelHorovitz = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/245"><h3>Michael Horovitz</h3></a><p>29 Colville Terrace<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(michaelHorovitz);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="michaelHorovitz.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="michaelHorovitz.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var jeremyHilton = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/246"><h3>Jeremy Hilton</h3></a><p>20 Inkerman Terrace<br />Whitehaven, Cumbria, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(jeremyHilton);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="jeremyHilton.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="jeremyHilton.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([52.1963749, 0.1335726], {
            color: jeremyHiltonColor
          }).bindPopup('<a href="/people/246"><h3>Jeremy Hilton</h3></a><p>17 Tenison Ave<br />Cambridge, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(jeremyHilton);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="jeremyHilton.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="jeremyHilton.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var bobHowell = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/250"><h3>Bob Howell</h3></a><p>2306 Ellsworth St #3<br />Berkeley, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(bobHowell);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="bobHowell.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="bobHowell.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([42.3842118, -71.1225382], {
            color: bobHowellColor
          }).bindPopup('<a href="/people/250"><h3>Bob Howell</h3></a><p>5 Washington Ave #5<br />Cambridge, MA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(bobHowell);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="bobHowell.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="bobHowell.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([39.869592, -86.09254], {
            color: bobHowellColor
          }).bindPopup('<a href="/people/250"><h3>Bob Howell</h3></a><p>6230 Brookline Dr<br />Indianapolis, IN<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(bobHowell);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="bobHowell.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="bobHowell.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.109505, -88.216258], {
            color: bobHowellColor
          }).bindPopup('<a href="/people/250"><h3>Bob Howell</h3></a><p>403 S Coler Ave<br />Urbana, IL<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(bobHowell);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="bobHowell.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="bobHowell.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([51.5298362, -0.1677228], {
            color: bobHowellColor
          }).bindPopup('<a href="/people/250"><h3>Bob Howell</h3></a><p>150 Park Rd<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(bobHowell);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="bobHowell.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="bobHowell.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([51.7571191, -1.2645895], {
            color: bobHowellColor
          }).bindPopup('<a href="/people/250"><h3>Bob Howell</h3></a><p>7 Richmond Rd<br />Oxford, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(bobHowell);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="bobHowell.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="bobHowell.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var barryHall = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/263"><h3>Barry Hall</h3></a><p>970 Acequia Madre<br />Santa Fe, NM<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(barryHall);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="barryHall.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="barryHall.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([51.5462115, -0.1852429], {
            color: barryHallColor
          }).bindPopup('<a href="/people/263"><h3>Barry Hall</h3></a><p>102 Fairhazel Gardens<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(barryHall);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="barryHall.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="barryHall.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ...
      var kennethIrby = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/269"><h3>Kenneth Irby</h3></a><p>1579 48th Ave<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(kennethIrby);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="kennethIrby.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="kennethIrby.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.7749295, -122.4194155], {
            color: kennethIrbyColor
          }).bindPopup('<a href="/people/269"><h3>Kenneth Irby</h3></a><p>PO Box 5880<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(kennethIrby);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="kennethIrby.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="kennethIrby.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var barryMiles = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/274"><h3>Barry Miles</h3></a><p>100A Southampton Row<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(barryMiles);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="barryMiles.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="barryMiles.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([51.5198084, -0.1404187], {
            color: barryMilesColor
          }).bindPopup('<a href="/people/274"><h3>Barry Miles</h3></a><p>Flat 8, 15 Hanson St Fitzrovia<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(barryMiles);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="barryMiles.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="barryMiles.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([51.5076125, -0.1372408], {
            color: barryMilesColor
          }).bindPopup('<a href="/people/274"><h3>Barry Miles</h3></a><p>6 Masons Yard St. James’s<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(barryMiles);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="barryMiles.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="barryMiles.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([51.5203119, -0.1223896], {
            color: barryMilesColor
          }).bindPopup('<a href="/people/274"><h3>Barry Miles</h3></a><p>102 Southampton Row<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(barryMiles);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="barryMiles.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="barryMiles.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var aramSaroyan = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/287"><h3>Aram Saroyan</h3></a><p>21 Watson St<br />Cambridge, MA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(aramSaroyan);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="aramSaroyan.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="aramSaroyan.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.7327796, -73.9934835], {
            color: aramSaroyanColor
          }).bindPopup('<a href="/people/287"><h3>Aram Saroyan</h3></a><p>Hotel Albert 23 E 10th St<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(aramSaroyan);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="aramSaroyan.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="aramSaroyan.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([42.507618, -70.847315], {
            color: aramSaroyanColor
          }).bindPopup('<a href="/people/287"><h3>Aram Saroyan</h3></a><p>21 Washington St<br />Marblehead, MA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(aramSaroyan);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="aramSaroyan.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="aramSaroyan.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.852358, -122.264611], {
            color: aramSaroyanColor
          }).bindPopup('<a href="/people/287"><h3>Aram Saroyan</h3></a><p>2134 Woolsey St<br />Berkeley, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(aramSaroyan);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="aramSaroyan.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="aramSaroyan.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([42.362431, -71.112449], {
            color: aramSaroyanColor
          }).bindPopup('<a href="/people/287"><h3>Aram Saroyan</h3></a><p>268 River St<br />Cambridge, MA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(aramSaroyan);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="aramSaroyan.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="aramSaroyan.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.739067, -73.999716], {
            color: aramSaroyanColor
          }).bindPopup('<a href="/people/287"><h3>Aram Saroyan</h3></a><p>68 7th Ave<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(aramSaroyan);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="aramSaroyan.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="aramSaroyan.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.7729411, -73.9503644], {
            color: aramSaroyanColor
          }).bindPopup('<a href="/people/287"><h3>Aram Saroyan</h3></a><p>440 E 81st St #2D<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(aramSaroyan);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="aramSaroyan.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="aramSaroyan.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([42.3464463, -71.0871804], {
            color: aramSaroyanColor
          }).bindPopup('<a href="/people/287"><h3>Aram Saroyan</h3></a><p>Belvedere Place, 1 Central Square<br />Cambridge, MA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(aramSaroyan);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="aramSaroyan.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="aramSaroyan.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.774153, -73.950352], {
            color: aramSaroyanColor
          }).bindPopup('<a href="/people/287"><h3>Aram Saroyan</h3></a><p>411 E 82nd St #2A<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(aramSaroyan);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="aramSaroyan.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="aramSaroyan.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.788916, -73.97945], {
            color: aramSaroyanColor
          }).bindPopup('<a href="/people/287"><h3>Aram Saroyan</h3></a><p>335 W. 85th St<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(aramSaroyan);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="aramSaroyan.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="aramSaroyan.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([51.4903281, -0.1611227], {
            color: aramSaroyanColor
          }).bindPopup('<a href="/people/287"><h3>Aram Saroyan</h3></a><p>Whitelands House #57, Cheltenham Terrace, Chelsea<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(aramSaroyan);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="aramSaroyan.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="aramSaroyan.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.751458, -73.969513], {
            color: aramSaroyanColor
          }).bindPopup('<a href="/people/287"><h3>Aram Saroyan</h3></a><p>321 E 45th St<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(aramSaroyan);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="aramSaroyan.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="aramSaroyan.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var jimLowell = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/296"><h3>Jim Lowell</h3></a><p>401 Euclid Ave (465 The Arcade)<br />Cleveland, OH<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(jimLowell);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="jimLowell.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="jimLowell.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var philipLamantia = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/297"><h3>Philip Lamantia</h3></a><p>American Express<br />Athens, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(philipLamantia);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="philipLamantia.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="philipLamantia.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.8011782, -122.4064034], {
            color: philipLamantiaColor
          }).bindPopup('<a href="/people/297"><h3>Philip Lamantia</h3></a><p>30 Genoa Pl<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(philipLamantia);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="philipLamantia.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="philipLamantia.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var gregKuzma = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/311"><h3>Greg Kuzma</h3></a><p>134 Normal Ave<br />Slippery Rock, PA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(gregKuzma);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="gregKuzma.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="gregKuzma.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var richardKolmar = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/316"><h3>Richard Kolmar</h3></a><p>45 E 68th St<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(richardKolmar);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="richardKolmar.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="richardKolmar.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.7737324, -73.9553281], {
            color: richardKolmarColor
          }).bindPopup('<a href="/people/316"><h3>Richard Kolmar</h3></a><p>239 E 79th St<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(richardKolmar);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="richardKolmar.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="richardKolmar.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.848466, -122.4805816], {
            color: richardKolmarColor
          }).bindPopup('<a href="/people/316"><h3>Richard Kolmar</h3></a><p>110 2nd St<br />Sausalito, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(richardKolmar);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="richardKolmar.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="richardKolmar.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.7784659, -122.4349088], {
            color: richardKolmarColor
          }).bindPopup('<a href="/people/316"><h3>Richard Kolmar</h3></a><p>1394 McAllister St<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(richardKolmar);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="richardKolmar.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="richardKolmar.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var edwardKissam = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/318"><h3>Edward Kissam</h3></a><p>American Express, Phoenicia Hotel<br />Beirut, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(edwardKissam);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="edwardKissam.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="edwardKissam.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.3439888, -74.6514481], {
            color: edwardKissamColor
          }).bindPopup('<a href="/people/318"><h3>Edward Kissam</h3></a><p>Dodge &amp; Osborn Hall, Princeton University<br />Princeton, NJ<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(edwardKissam);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="edwardKissam.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="edwardKissam.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.344943, -74.637984], {
            color: edwardKissamColor
          }).bindPopup('<a href="/people/318"><h3>Edward Kissam</h3></a><p>53 McCosh Circle<br />Princeton, NJ<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(edwardKissam);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="edwardKissam.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="edwardKissam.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.7616556, -122.4431182], {
            color: edwardKissamColor
          }).bindPopup('<a href="/people/318"><h3>Edward Kissam</h3></a><p>208 Corbett Ave<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(edwardKissam);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="edwardKissam.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="edwardKissam.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var jamesKoller = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/323"><h3>James Koller</h3></a><p>409 Camino Del Monte Sol<br />Santa Fe, NM<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(jamesKoller);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="jamesKoller.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="jamesKoller.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([44.3486793, -70.0661649], {
            color: jamesKollerColor
          }).bindPopup('<a href="/people/323"><h3>James Koller</h3></a><p>PO Box 223<br />Wayne, ME<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(jamesKoller);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="jamesKoller.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="jamesKoller.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.964926, -122.5333747], {
            color: jamesKollerColor
          }).bindPopup('<a href="/people/323"><h3>James Koller</h3></a><p>233 D St San Rafael<br />San Rafael, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(jamesKoller);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="jamesKoller.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="jamesKoller.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([41.3680919, -89.4648145], {
            color: jamesKollerColor
          }).bindPopup('<a href="/people/323"><h3>James Koller</h3></a><p>RR #2<br />Princeton, IL<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(jamesKoller);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="jamesKoller.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="jamesKoller.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([38.375819, -122.811343], {
            color: jamesKollerColor
          }).bindPopup('<a href="/people/323"><h3>James Koller</h3></a><p>538 Sparkes Rd<br />Sebastopol, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(jamesKoller);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="jamesKoller.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="jamesKoller.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var karelReisz = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/335"><h3>Karel Reisz</h3></a><p>15 Chalcot Gardens<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(karelReisz);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="karelReisz.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="karelReisz.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var ronaldJohnson = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/351"><h3>Ronald Johnson</h3></a><p>2 Well Rd<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(ronaldJohnson);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="ronaldJohnson.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="ronaldJohnson.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([51.5582317, -0.1742072], {
            color: ronaldJohnsonColor
          }).bindPopup('<a href="/people/351"><h3>Ronald Johnson</h3></a><p>22 Well Walk<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(ronaldJohnson);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="ronaldJohnson.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="ronaldJohnson.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var christopherMiddleton = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/357"><h3>Christopher Middleton</h3></a><p>Hesper House, Wells Park Rd<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(christopherMiddleton);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="christopherMiddleton.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="christopherMiddleton.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var wSMerwin = L.featureGroup([
          L.circleMarker([44.91565, 1.83836], {
            color: wSMerwinColor
          }).bindPopup('<a href="/people/358"><h3>W.S. Merwin</h3></a><p>Lacan de Loubressac par Bretenoux<br />Lot, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(wSMerwin);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="wSMerwin.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="wSMerwin.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var cavanMccarthy = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/363"><h3>Cavan McCarthy</h3></a><p>22 Brudenell Rd<br />Leeds, West Yorkshire, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(cavanMccarthy);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="cavanMccarthy.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="cavanMccarthy.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([53.7442268, -2.5000809], {
            color: cavanMccarthyColor
          }).bindPopup('<a href="/people/363"><h3>Cavan McCarthy</h3></a><p>4 Hornby Ct<br />Blackburn, Blackburn with Darwen, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(cavanMccarthy);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="cavanMccarthy.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="cavanMccarthy.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([53.8186616, -1.5626482], {
            color: cavanMccarthyColor
          }).bindPopup('<a href="/people/363"><h3>Cavan McCarthy</h3></a><p>Flat A, Grosvenor Court, 3 Grosvenor Rd<br />Leeds, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(cavanMccarthy);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="cavanMccarthy.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="cavanMccarthy.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var lewisMacadams = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/373"><h3>Lewis MacAdams</h3></a><p>Foulke Hall, Princeton University<br />Princeton, NJ<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(lewisMacadams);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="lewisMacadams.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="lewisMacadams.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([32.87247, -96.8875769], {
            color: lewisMacadamsColor
          }).bindPopup('<a href="/people/373"><h3>Lewis MacAdams</h3></a><p>2635 Brenner Dr<br />Dallas, TX<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(lewisMacadams);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="lewisMacadams.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="lewisMacadams.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([32.8931929, -96.816856], {
            color: lewisMacadamsColor
          }).bindPopup('<a href="/people/373"><h3>Lewis MacAdams</h3></a><p>5233 Lobello Dr<br />Dallas, TX<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(lewisMacadams);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="lewisMacadams.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="lewisMacadams.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([42.950489, -78.903465], {
            color: lewisMacadamsColor
          }).bindPopup('<a href="/people/373"><h3>Lewis MacAdams</h3></a><p>204 Ontario St<br />Buffalo, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(lewisMacadams);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="lewisMacadams.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="lewisMacadams.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([42.915119, -78.8827079], {
            color: lewisMacadamsColor
          }).bindPopup('<a href="/people/373"><h3>Lewis MacAdams</h3></a><p>468 W Ferry St<br />Buffalo, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(lewisMacadams);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="lewisMacadams.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="lewisMacadams.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.77262, -122.420437], {
            color: lewisMacadamsColor
          }).bindPopup('<a href="/people/373"><h3>Lewis MacAdams</h3></a><p>60 Brady St<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(lewisMacadams);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="lewisMacadams.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="lewisMacadams.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.755275, -122.398432], {
            color: lewisMacadamsColor
          }).bindPopup('<a href="/people/373"><h3>Lewis MacAdams</h3></a><p>969 Wisconsin St<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(lewisMacadams);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="lewisMacadams.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="lewisMacadams.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.731867, -73.983213], {
            color: lewisMacadamsColor
          }).bindPopup('<a href="/people/373"><h3>Lewis MacAdams</h3></a><p>PO Box 94, Stuyvesant Station<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(lewisMacadams);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="lewisMacadams.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="lewisMacadams.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var stuartMills = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/384"><h3>Stuart Mills</h3></a><p>32 Mensing Ave Cotgrave<br />Nottingham, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(stuartMills);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="stuartMills.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="stuartMills.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var edwinMorgan = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/385"><h3>Edwin Morgan</h3></a><p>19 Whittingehame Court, 1350 Great Western Rd<br />Glasgow, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(edwinMorgan);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="edwinMorgan.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="edwinMorgan.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var missyMaytag = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/387"><h3>Missy Maytag</h3></a><p>905 Embarcadero del Norte Isla Vista<br />Santa Barbara, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(missyMaytag);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="missyMaytag.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="missyMaytag.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var donMclaughlin = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/392"><h3>Don McLaughlin</h3></a><p>22154 Avenue San Luis<br />Los Angeles, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(donMclaughlin);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="donMclaughlin.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="donMclaughlin.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.789105, -122.4359821], {
            color: donMclaughlinColor
          }).bindPopup('<a href="/people/392"><h3>Don McLaughlin</h3></a><p>17 Perine Pl<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(donMclaughlin);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="donMclaughlin.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="donMclaughlin.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var pierreMartory = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/395"><h3>Pierre Martory</h3></a><p>25 Rue Charles V<br />Paris, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(pierreMartory);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="pierreMartory.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="pierreMartory.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var hedleyMorgan = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/396"><h3>Hedley Morgan</h3></a><p>30 Bluebridge Rd, Brookmans Park<br />Hatfield, Hertfordshire, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(hedleyMorgan);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="hedleyMorgan.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="hedleyMorgan.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var charlesOlson = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/409"><h3>Charles Olson</h3></a><p><br />Wyoming, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(charlesOlson);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="charlesOlson.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="charlesOlson.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([42.6085939, -70.664284], {
            color: charlesOlsonColor
          }).bindPopup('<a href="/people/409"><h3>Charles Olson</h3></a><p>28 Fort Square<br />Gloucester, MA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(charlesOlson);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="charlesOlson.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="charlesOlson.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([42.0510329, -71.383368], {
            color: charlesOlsonColor
          }).bindPopup('<a href="/people/409"><h3>Charles Olson</h3></a><p>22 Mount St.<br />, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(charlesOlson);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="charlesOlson.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="charlesOlson.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var marianODwyer = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/411"><h3>Marian O’Dwyer</h3></a><p>18 Webster Rd<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(marianODwyer);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="marianODwyer.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="marianODwyer.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var laurenOwen = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/412"><h3>Lauren Owen</h3></a><p>Okawamuchi Yamashira-chio<br />Miyoshi-gun Tokushima-ken, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(laurenOwen);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="laurenOwen.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="laurenOwen.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var edgarOwen = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/414"><h3>Edgar Owen</h3></a><p>Meguroku, Naka Meguro 4-chome 1424<br />Tokyo, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(edgarOwen);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="edgarOwen.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="edgarOwen.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var bobCallahan = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/418"><h3>Bob Callahan</h3></a><p>2907 Bush St<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(bobCallahan);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="bobCallahan.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="bobCallahan.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var ronPadgett = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/425"><h3>Ron Padgett</h3></a><p>210 W 88th St<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(ronPadgett);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="ronPadgett.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="ronPadgett.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([36.15581, -95.950029], {
            color: ronPadgettColor
          }).bindPopup('<a href="/people/425"><h3>Ron Padgett</h3></a><p>2733 E 4th St<br />Tulsa, OK<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(ronPadgett);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="ronPadgett.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="ronPadgett.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.730763, -73.983955], {
            color: ronPadgettColor
          }).bindPopup('<a href="/people/425"><h3>Ron Padgett</h3></a><p>342 E 13th St<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(ronPadgett);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="ronPadgett.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="ronPadgett.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([36.0607396, -95.9372366], {
            color: ronPadgettColor
          }).bindPopup('<a href="/people/425"><h3>Ron Padgett</h3></a><p>3819 S Jamestown<br />Tulsa, OK<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(ronPadgett);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="ronPadgett.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="ronPadgett.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([48.8538435, 2.3784386], {
            color: ronPadgettColor
          }).bindPopup('<a href="/people/425"><h3>Ron Padgett</h3></a><p>1 Passage Rauch<br />Paris, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(ronPadgett);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="ronPadgett.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="ronPadgett.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var stanPersky = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/428"><h3>Stan Persky</h3></a><p>24 Allen St<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(stanPersky);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="stanPersky.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="stanPersky.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var joePinelli = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/436"><h3>Joe Pinelli</h3></a><p>283 E Houston St<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(joePinelli);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="joePinelli.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="joePinelli.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.7249796, -73.9781509], {
            color: joePinelliColor
          }).bindPopup('<a href="/people/436"><h3>Joe Pinelli</h3></a><p>134 Avenue C #7<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(joePinelli);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="joePinelli.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="joePinelli.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.721026, -73.983804], {
            color: joePinelliColor
          }).bindPopup('<a href="/people/436"><h3>Joe Pinelli</h3></a><p>6 Clinton St #5<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(joePinelli);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="joePinelli.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="joePinelli.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([55.6905473, 12.5610302], {
            color: joePinelliColor
          }).bindPopup('<a href="/people/436"><h3>Joe Pinelli</h3></a><p>DIS Student Hostel, Sankt Hans Torv 26<br />Copenhagen, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(joePinelli);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="joePinelli.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="joePinelli.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([55.6813913, 12.5912244], {
            color: joePinelliColor
          }).bindPopup('<a href="/people/436"><h3>Joe Pinelli</h3></a><p>Hotel Sankt Annæ, Sankt Annæ Plads 12<br />Copenhagen, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(joePinelli);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="joePinelli.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="joePinelli.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([55.6833023, 12.5677456], {
            color: joePinelliColor
          }).bindPopup('<a href="/people/436"><h3>Joe Pinelli</h3></a><p>Rømersgade 7<br />Copenhagen, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(joePinelli);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="joePinelli.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="joePinelli.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.723903, -73.980852], {
            color: joePinelliColor
          }).bindPopup('<a href="/people/436"><h3>Joe Pinelli</h3></a><p>620 E 6th St #19<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(joePinelli);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="joePinelli.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="joePinelli.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var louLipsitz = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/442"><h3>Lou Lipsitz</h3></a><p>Town House Apartments #3A 425 Hillsborough St<br />Chapel Hill, NC<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(louLipsitz);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="louLipsitz.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="louLipsitz.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([41.900625, -87.628333], {
            color: louLipsitzColor
          }).bindPopup('<a href="/people/442"><h3>Lou Lipsitz</h3></a><p>1019 N State St<br />Chicago, IL<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(louLipsitz);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="louLipsitz.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="louLipsitz.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var michaelPalmer = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/448"><h3>Michael Palmer</h3></a><p>234 Hermann St<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(michaelPalmer);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="michaelPalmer.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="michaelPalmer.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.7650017, -122.4339767], {
            color: michaelPalmerColor
          }).bindPopup('<a href="/people/448"><h3>Michael Palmer</h3></a><p>17 Beaver St<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(michaelPalmer);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="michaelPalmer.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="michaelPalmer.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var davidRay = L.featureGroup([
          L.circleMarker([45.488734, -122.635902], {
            color: davidRayColor
          }).bindPopup('<a href="/people/452"><h3>David Ray</h3></a><p>2866 SE Long St<br />Portland, OR<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(davidRay);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="davidRay.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="davidRay.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([45.472104, -122.616981], {
            color: davidRayColor
          }).bindPopup('<a href="/people/452"><h3>David Ray</h3></a><p>4417 SE Rural St<br />Portland, OR<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(davidRay);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="davidRay.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="davidRay.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([45.4809642, -122.6301455], {
            color: davidRayColor
          }).bindPopup('<a href="/people/452"><h3>David Ray</h3></a><p>3203 SE Woodstock Blvd<br />Portland, OR<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(davidRay);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="davidRay.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="davidRay.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var katieRuse = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/457"><h3>Katie Ruse</h3></a><p>20 Fitzroy Rd<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(katieRuse);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="katieRuse.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="katieRuse.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var carlRakosi = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/458"><h3>Carl Rakosi</h3></a><p>4451 Colfax Ave S<br />Minneapolis, MN<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(carlRakosi);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="carlRakosi.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="carlRakosi.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var williamRivera = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/464"><h3>William Rivera</h3></a><p>52 Rue Vaneau<br />Paris, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(williamRivera);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="williamRivera.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="williamRivera.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var jeromeRothenberg = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/472"><h3>Jerome Rothenberg</h3></a><p>600 W 163rd St<br />New York, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(jeromeRothenberg);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="jeromeRothenberg.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="jeromeRothenberg.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var gerritLansing = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/487"><h3>Gerrit Lansing</h3></a><p>92 Main St<br />Gloucester, MA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(gerritLansing);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="gerritLansing.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="gerritLansing.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var bernardStone = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/496"><h3>Bernard Stone</h3></a><p>19 Kensington Church Walk Kensington<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(bernardStone);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="bernardStone.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="bernardStone.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var davidShapiro = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/501"><h3>David Shapiro</h3></a><p>66 Parkview Terrace<br />Newark, NJ<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(davidShapiro);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="davidShapiro.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="davidShapiro.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.8065688, -73.9608601], {
            color: davidShapiroColor
          }).bindPopup('<a href="/people/501"><h3>David Shapiro</h3></a><p>438 W 116th St #36<br />New York, NY<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(davidShapiro);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="davidShapiro.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="davidShapiro.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([52.2063747, 0.1170187], {
            color: davidShapiroColor
          }).bindPopup('<a href="/people/501"><h3>David Shapiro</h3></a><p>Trinity Lane<br />Cambridge, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(davidShapiro);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="davidShapiro.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="davidShapiro.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var nickSedgwick = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/504"><h3>Nick Sedgwick</h3></a><p>53 Butt Rd<br />Colchester, Essex, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(nickSedgwick);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="nickSedgwick.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="nickSedgwick.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([52.2296448, 0.087347], {
            color: nickSedgwickColor
          }).bindPopup('<a href="/people/504"><h3>Nick Sedgwick</h3></a><p>12 Thornton Rd Girton<br />Cambridge, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(nickSedgwick);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="nickSedgwick.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="nickSedgwick.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var charlesTomlinson = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/522"><h3>Charles Tomlinson</h3></a><p>Brook Cottage<br />Ozleworth, Wotton-under-Edge, Gloucestershire, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(charlesTomlinson);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="charlesTomlinson.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="charlesTomlinson.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var gaelTurnbull = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/523"><h3>Gael Turnbull</h3></a><p>Bridge House, Stiffords Bridge<br />Cradley, Malvern, Worcestershire, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(gaelTurnbull);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="gaelTurnbull.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="gaelTurnbull.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var georgeTysh = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/531"><h3>George Tysh</h3></a><p>7 Rue Jacques Louvel-Tessier<br />Paris, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(georgeTysh);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="georgeTysh.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="georgeTysh.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var sotereTorregian = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/532"><h3>Sotère Torregian</h3></a><p>333 Waverley St<br />Palo Alto, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(sotereTorregian);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="sotereTorregian.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="sotereTorregian.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([40.739661, -74.2087458], {
            color: sotereTorregianColor
          }).bindPopup('<a href="/people/532"><h3>Sotère Torregian</h3></a><p>493 S 18th St<br />Newark, NJ<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(sotereTorregian);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="sotereTorregian.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="sotereTorregian.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.42382, -122.14847], {
            color: sotereTorregianColor
          }).bindPopup('<a href="/people/532"><h3>Sotère Torregian</h3></a><p>2280 Williams St<br />Palo Alto, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(sotereTorregian);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="sotereTorregian.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="sotereTorregian.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.311818, -121.921646], {
            color: sotereTorregianColor
          }).bindPopup('<a href="/people/532"><h3>Sotère Torregian</h3></a><p>831 Menker Ave<br />San Jose, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(sotereTorregian);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="sotereTorregian.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="sotereTorregian.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var jackieMonnier = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/536"><h3>Jackie Monnier</h3></a><p>108 Rue du Bac<br />Paris, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(jackieMonnier);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="jackieMonnier.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="jackieMonnier.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var tamasUngvari = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/541"><h3>Tamas Ungvari</h3></a><p>Istenhegyi út 95<br />Budapest, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(tamasUngvari);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="tamasUngvari.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="tamasUngvari.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var charlieVermont = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/546"><h3>Charlie Vermont</h3></a><p>69 Henry St<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(charlieVermont);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="charlieVermont.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="charlieVermont.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([44.055137, -123.107412], {
            color: charlieVermontColor
          }).bindPopup('<a href="/people/546"><h3>Charlie Vermont</h3></a><p>956 W 4th Ave<br />Eugene, OR<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(charlieVermont);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="charlieVermont.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="charlieVermont.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([44.4112314, -123.9003916], {
            color: charlieVermontColor
          }).bindPopup('<a href="/people/546"><h3>Charlie Vermont</h3></a><p>Star Route 2, PO Box 5A<br />Tidewater, OR<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(charlieVermont);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="charlieVermont.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="charlieVermont.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([35.180885, -106.624782], {
            color: charlieVermontColor
          }).bindPopup('<a href="/people/546"><h3>Charlie Vermont</h3></a><p>8812 4th St NW<br />Los Ranchos de Albuquerque, NM<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(charlieVermont);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="charlieVermont.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="charlieVermont.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.765983, -122.450775], {
            color: charlieVermontColor
          }).bindPopup('<a href="/people/546"><h3>Charlie Vermont</h3></a><p>122 Carl St #4<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(charlieVermont);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="charlieVermont.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="charlieVermont.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var drewWagnon = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/550"><h3>Drew Wagnon</h3></a><p>1568 Fell St<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(drewWagnon);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="drewWagnon.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="drewWagnon.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.7682169, -122.4474228], {
            color: drewWagnonColor
          }).bindPopup('<a href="/people/550"><h3>Drew Wagnon</h3></a><p>39 Downey St<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(drewWagnon);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="drewWagnon.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="drewWagnon.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var willWroth = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/553"><h3>Will Wroth</h3></a><p>1175 E 25th Ave<br />Eugene, OR<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(willWroth);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="willWroth.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="willWroth.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.8653369, -122.274288], {
            color: willWrothColor
          }).bindPopup('<a href="/people/553"><h3>Will Wroth</h3></a><p>2337 Grant St B<br />Berkeley, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(willWroth);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="willWroth.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="willWroth.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.822862, -122.253328], {
            color: willWrothColor
          }).bindPopup('<a href="/people/553"><h3>Will Wroth</h3></a><p>91 Rio Vista Ave<br />Oakland, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(willWroth);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="willWroth.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="willWroth.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var philipWhalen = L.featureGroup([
          L.circleMarker([35.0485688, 135.7785475], {
            color: philipWhalenColor
          }).bindPopup('<a href="/people/570"><h3>Philip Whalen</h3></a><p>73 Higashikubota-Cho, Kita-Shirakitna, Sakyo-Ku<br />Kyoto, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(philipWhalen);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="philipWhalen.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="philipWhalen.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([37.7851789, -122.440323], {
            color: philipWhalenColor
          }).bindPopup('<a href="/people/570"><h3>Philip Whalen</h3></a><p>2427 Sutter St<br />San Francisco, CA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(philipWhalen);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="philipWhalen.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="philipWhalen.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
          L.circleMarker([35.0101327, 135.7160784], {
            color: philipWhalenColor
          }).bindPopup('<a href="/people/570"><h3>Philip Whalen</h3></a><p>Fukuoji-Cho 82, Ano, Ukyo-Ku<br />Kyoto, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(philipWhalen);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="philipWhalen.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="philipWhalen.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var mikeWiater = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/582"><h3>Mike Wiater</h3></a><p>922 E Alder St<br />Seattle, WA<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(mikeWiater);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="mikeWiater.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="mikeWiater.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var jimZimmerman = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/594"><h3>Jim Zimmerman</h3></a><p>PO Box 7181, Roseville Station<br />Newark, NJ<br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(jimZimmerman);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="jimZimmerman.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="jimZimmerman.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
      ...
      var raoulHausmann = L.featureGroup([
          ...
          }).bindPopup('<a href="/people/598"><h3>Raoul Hausmann</h3></a><p>Hereford Buildings #23, Old Church St Chelsea<br />London, <br /></p><div class="btn-group btn-group-sm" role="group" aria-label="..."><button type="button" class="btn btn-default" onClick="map.removeLayer(raoulHausmann);resetColor(style);"><span class="glyphicon glyphicon-remove"></span></button><button type="button" class="btn btn-default" onClick="raoulHausmann.bringToFront()"><span class="glyphicon glyphicon-arrow-up"></span></button><button type="button" class="btn btn-default" onClick="raoulHausmann.bringToBack()"><span class="glyphicon glyphicon-arrow-down"></span></button></div>'),
      ]);
